...
assert(script.includes('from "modern-screenshot";'), "expected modern-screenshot import");
...
assert(script.includes('"captureStrategy":"modern-screenshot"'), "expected capture strategy runtime option");
